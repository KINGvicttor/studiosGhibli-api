export const MovieList = () => {
    return (
        <section className="mt-10">
            <div className="container mx-auto h-[1782px]">
                <div className="w-[302px] h-[911px] rounded-lg">
                    ...
                    <div className="w-full h-[311px] px-3 py-3 bg-white">
                        <h1 className="text-xl font-bold">Castle in the Sky</h1>
                        <p className="text-sm mt-1">1986 <span>•</span> 2h 4m</p>
                        ...
                        <div className="w-full text-justify mt-2">
                            <p className="text-sm">The orphan Sheeta inherited a mysterious crystal that links her to the mythical sky-kingdom of Laputa. With the help of...</p>
                        ...
                        <div>
                            <p className="text-sm mt-2 text-gray-600">Director: Hayao Mizayaki</p>
                            <p className="text-sm mt-2 text-gray-600">Producer: Isao Takahata</p>
                        </div>
                    </div>
