...
export const MovieList = () => {
    ...
    const removeFilters = () => {
        movieCtx?.setShowMovies(true)
        movieCtx?.setShowWatched(false)
    }
            ...
            <div className="container mx-auto h-auto pb-10 px-10 flex justify-center items-center flex-wrap gap-x-10 gap-y-10">
                        ...
                        <div className="w-[302px] h-[911px] rounded-lg hover:shadow-2xl hover:ease-in-out hover:duration-500" key={index}>
                            ...
                            <div className="w-full h-[148px] flex flex-col justify-around items-center bg-white rounded-b-lg">
                                <div className="flex justify-center items-center w-[268px] h-[36px] border border-gray-500 rounded-lg cursor-pointer hover:bg-gray-200">
                                    <button onClick={() => movieCtx?.addWatchedMovie(index, movie)} className="flex cursor-pointer w-full h-full justify-center items-center   ">
                ...
                {movieCtx?.showWatched && movieCtx?.watchedMovieList.length === 0 &&
                    <div className="container mx-auto flex flex-col items-center h-[calc(100vh-375px)] py-10">
                        ...
                        <button onClick={() => removeFilters()} className="bg-white border border-gray-500 px-3 py-2 rounded-lg mt-4 cursor-pointer hover:bg-gray-200">Clear All Filters</button>
                    </div>
                }
            </div>
        </section>
