                ...
                <div className="w-full h-[40px] flex sm:mt-2">
                    <div className="w-full h-[40px] flex items-center">
                        <div className="w-[70%] flex items-center">
                            ...
                            {/* Mostrar filmes marcados como vistos */}
                            ...
                            {movieCtx?.showWatched &&
                                <button onClick={() => movieCtx?.showWatchedBtn()} className="flex px-3 py-2 ml-8 cursor-pointer rounded-lg bg-black text-white hover:bg-black/80 sm:ml-2 sm:text-sm">
                            ...
                            {/* Mostrar filmes marcados como favoritos */}
                            ...
                            {movieCtx?.showFavorite &&
                                <button onClick={() => movieCtx?.showFavoriteBtn()} className="flex px-3 py-2 ml-8 cursor-pointer rounded-lg bg-red-600 text-white hover:bg-red-600/80 sm:ml-2 sm:text-sm">
                                    <svg className="w-5 h-5 text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                                        <path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12.01 6.001C6.5 1 1 8 5.782 13.001L12.011 20l6.23-7C23 8 17.5 1 12.01 6.002Z" />
                                    </svg>
                                    <p className="text-sm ml-1">Favorites</p>
                            ...
                            {/* Mostrar filmes que possuem anotações */}
                            {!movieCtx?.showNoted &&
                            ...
                            {movieCtx?.showNoted &&
                                <button onClick={() => movieCtx?.showNotedBtn()} className="flex px-3 py-2 ml-8 cursor-pointer rounded-lg bg-blue-600 text-white hover:bg-blue-600/80 sm:ml-2 sm:text-sm">
                                    <svg className="w-5 h-5 text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                                        <path stroke="currentColor" strokeLinejoin="round" strokeWidth="2" d="M10 3v4a1 1 0 0 1-1 1H5m14-4v16a1 1 0 0 1-1 1H6a1 1 0 0 1-1-1V7.914a1 1 0 0 1 .293-.707l3.914-3.914A1 1 0 0 1 9.914 3H18a1 1 0 0 1 1 1Z" />
                                    </svg>
                                    <p className="text-sm ml-1">With notes</p>
